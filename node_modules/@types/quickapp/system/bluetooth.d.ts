...
declare module '@system.bluetooth' {
     ...
     * @param obj
     */
    export function openAdapter(obj: {
        /**
     ...
     * @param obj
     */
    export function closeAdapter(obj: {
        /**
     ...
     * @param obj
     */
    export function getAdapterState(obj: {
        /**
         * 成功回调
         */
        success?: (data: {
     ...
     * 监听蓝牙适配器状态变化事件
     */
    export let onadapterstatechange: (data: {
        available: boolean,
        discovering: boolean
    }) => void
     ...
     * @param obj
     */
    export function startDevicesDiscovery(obj: {
        /**
     ...
     */
    export function stopDevicesDiscovery(obj: {
        /**
         * 成功回调
         */
        success?: () => void,
     ...
     * @param obj
     */
    export function getConnectedDevices(obj: {
        /**
     ...
     */
    export let onblecharacteristicvaluechange: (data: {
        /**
         * 蓝牙设备 id
         */
        deviceId: string,
     ...
     */
    export let onbleconnectionstatechange: (data: {
        /**
         * 蓝牙设备 id
         */
        deviceId: string,
