...
declare module '@system.image' {
     ...
     * @param obj
     */
    export function compressImage(obj: {
        /**
         * 图片地址，可以是数据文件或应用内的资源。如果是应用内资源，必须使用绝对路径
         */
        uri: string,
     ...
     * @param obj
     */
    export function getExifAttributes(obj: {
        /**
         * 图片地址，可以是数据文件或应用内的资源。如果是应用内资源，必须使用绝对路径
         */
        uri: string,
     ...
     * @param obj
     */
    export function setExifAttributes(obj: {
        /**
         * 图片地址，可以是数据文件或应用内的资源。如果是应用内资源，必须使用绝对路径
         */
        uri: string,
     ...
     * @param obj
     */
    export function applyOperations(obj: {
        /**
         * 图片地址，可以是数据文件或应用内的资源。如果是应用内资源，必须使用绝对路径
         */
        uri: string,
